...
This document shows prompt snippets for the OpenAI API implementation.
The prompts are constructed from `src/local_funcs/src/local_funcs/prompt_templates.py`.
